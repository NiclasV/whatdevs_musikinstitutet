...
function displayArtists(artistsData) {
    ...
    for (let artist of aristisNameArray) {
        ...
        <div class="artistCard">
            ...
            </div><strong><a href="${ artist.spotifyURL }">Spotify URL</a></strong><br/><br/>
        </div>`;
    }    
...
function displaySpecific(data, id) {
    var artist = data;
    var name = data.name;
    var artistId = id;
    var content = ``; 
    ...
    <a href="${artist.spotifyURL}" target="_blank">Spotify</a><br>
    <a href="javascript://delete" id="${artistId}"  onClick="deleteFrom(this.id)">Delete Artist</button>
    </div>
    `
